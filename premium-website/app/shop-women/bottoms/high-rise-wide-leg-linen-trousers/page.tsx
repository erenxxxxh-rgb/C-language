...
export default function BottomsDetailPage() {
  // PRODUCT DATA
  const amazonAffiliateUrl = "https://link.amazon/B0fOAvRPz"; // Your exact Amazon link
  
  // Media Array (Images and Videos)
  const mediaContent = [
    { type: "image", src: "/3a.png", alt: "Front view of linen trousers" },
    { type: "image", src: "/3b.png", alt: "Side view" }, 
    { type: "image", src: "/3c.png", alt: "Styled look" }, 
    { type: "image", src: "/3d.png", alt: "Styled look" }, 
  ];

  const colors = [
    { name: "Oatmeal", hex: "#E5D3B3", active: true },
    ...
    <main className="flex flex-col min-h-screen bg-[#D4A373] text-neutral-900 pt-28 pb-16 px-6 md:px-12">
      ...
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="flex flex-col gap-8 bg-white/50 backdrop-blur-md p-8 md:p-10 rounded-2xl border border-white/30 shadow-sm sticky top-32">
          ...
          {/* Title & Reviews */}
          <div>
            <p className="text-xs uppercase tracking-widest font-semibold text-neutral-600 mb-2">Everyday Bottoms</p>
            <h1 className="text-3xl md:text-4xl font-light uppercase tracking-widest text-black mb-4">
              High-Rise Wide Leg Linen Trousers
            </h1>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xs font-medium text-neutral-700">(84 Reviews)</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="text-sm text-neutral-800 space-y-2 list-disc list-inside leading-relaxed font-medium">
              <li>Effortlessly breezy linen blend fabric designed for warm-weather styling.</li>
              <li>Tailored high waist with a relaxed, flowing wide-leg silhouette.</li>
              <li>Functional side pockets and a clean, hidden zipper closure.</li>
              <li>Pairs perfectly with a tucked-in cap sleeve tee or a light crop top.</li>
            </ul>
          </div>
