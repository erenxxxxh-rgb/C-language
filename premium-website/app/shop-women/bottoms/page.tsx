...
export default function BottomsPage() {
  ...
  const products = [
    {
      id: "high-rise-wide-leg-linen-trousers",
      name: "PRETTYGARDEN Women's Palazzo Pants Casual Wide Leg Trousers | Crinkle Texture, Side Pockets, Decorative Drawstring, Elastic High Waist, Relaxed Fit, Beach Wear, Lightweight Flowy Slacks",
      category: "Everyday Bottoms",
      image: "/3a.png", // Make sure to drop a pic in the public folder!
      description: "Effortlessly breezy linen trousers with a tailored high waist and relaxed wide leg. Perfect for smart-casual summer aesthetics.",
      ...
      <section className="w-full pt-32 pb-12 px-6 text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <p className="text-neutral-800 max-w-xl text-base md:text-lg font-medium">
            Tailored linen shorts, aesthetic denim, and relaxed trousers. Build your outfit from the bottom up.
          </p>
        </div>
      </section>
