...
export default function OutfitDetailPage() {
  // PRODUCT DATA
  const amazonAffiliateUrl = "https://amzn.to/4gZcExs"; // Your exact link for this new set
  
  // Media Array (Images and Videos)
  const mediaContent = [
    { type: "image", src: "/4d.png", alt: "Front view of Knit Set" },
    { type: "image", src: "/4c.png", alt: "Back view" }, 
    { type: "image", src: "/4b.png", alt: "Styled look" }, 
    { type: "image", src: "/4e.png", alt: "Styled look" }, 
  ];

  const colors = [
    { name: "Mocha Brown", hex: "#4B3621", active: true },
    { name: "Cream White", hex: "#FDFBF7", active: false },
    { name: "Sage Green", hex: "#77815C", active: false },
  ];
        ...
        <div className="flex flex-col gap-8 bg-white/50 backdrop-blur-md p-8 md:p-10 rounded-2xl border border-white/30 shadow-sm sticky top-32">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xs font-medium text-neutral-700">(184 Reviews)</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mb-5 text-xs text-neutral-800 bg-white/40 p-4 rounded-xl border border-white/20 grid grid-cols-2 gap-3 shadow-sm">
              <div><span className="font-bold text-black">Fabric:</span> Viscose & Nylon Blend</div>
              <div><span className="font-bold text-black">Care:</span> Hand Wash Cold</div>
              <div><span className="font-bold text-black">Style:</span> Bodycon / Stretchy</div>
            </div>

            <ul className="text-sm text-neutral-800 space-y-3 list-disc list-inside leading-relaxed font-medium">
              <li><strong>Flattering Fit:</strong> Soft, ribbed knit material that hugs your curves while providing a comfortable stretch for all-day wear.</li>
              <li><strong>Versatile Pieces:</strong> Wear the cropped tank and midi skirt together for a cohesive look, or mix and match with other wardrobe staples.</li>
              <li><strong>Elegant Details:</strong> The skirt features a tasteful side slit for added mobility and a chic, modern aesthetic.</li>
              <li><strong>Transition Weather Staple:</strong> Perfect for layering under a trench coat or wearing solo during warmer days.</li>
            </ul>
          </div>
